...
radar_processor.py
-------------------------------------------------
MAYURI Radar Signal Processing System

Processes raw radar data for obstacle detection, range estimation,
and motion tracking in low-visibility environments.

==> Real / Simulated radar data support
==> Object detection with distance & velocity
==> Doppler shift-based motion analysis
==> Fusion-ready JSON output for AI & navigation
==> ROS2 integration with /mayuri/sensor/radar_data topic
