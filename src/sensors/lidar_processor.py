...
lidar_processor.py
-------------------------------------------------
MAYURI LIDAR Data Processing System

Processes raw LIDAR scan data into usable obstacle maps
and point clouds for navigation and AI-based fusion.

==> Supports real & simulated LIDAR data
==> Generates 2D occupancy grid
==> Publishes obstacle map for navigation
==> Integrated with sensor_fusion and path_planner
==> Noise filtering & safety radius logic
