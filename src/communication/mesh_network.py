...
Lightweight encrypted mesh communication module for MAYURI.
Allows multiple nodes to automatically discover each other and exchange
secure JSON messages in a local network (LAN / Wi-Fi).

✅ Uses AES-GCM encryption from encryption_manager.py
✅ Suitable for swarm robotics, coordination, and data sharing
❌ Not for defense or offensive use
"""
